...
**Hard Skills:** Business Requirements Document (BRD), Functional & Non-Functional Requirements Specification, Swimlane Diagrams (Lucidchart), Process Mapping, Documentation Tools (Word, Markdown)
